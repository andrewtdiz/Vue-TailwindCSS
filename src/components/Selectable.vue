<template>
  <div @click="selected = selected==0 ? 1 : 0" :class="selected==1 ? ['', ' border-brand-400'] : ['card-4', 'border-transparent' ]" class="w-56 h-56 rounded-lg cursor-pointer flex flex-col border-2">
